...
- **Cấp độ khó**: mỗi câu hỏi được Gemini gắn nhãn "Cơ bản"/"Trung bình"/"Nâng cao". Khi random đề thi, mỗi chương được chọn đều số câu ở cả 3 mức rồi sắp xếp Cơ bản → Trung bình → Nâng cao, để mỗi lượt làm bài đi từ dễ đến khó dù câu cụ thể được chọn ngẫu nhiên mỗi lần.
