...
- Việc tạo bài giảng + 100 câu hỏi có thể mất khoảng 30-60 giây tùy độ dài tài liệu (hàm `upload-document` được cấu hình `maxDuration: 60`).
- Nếu sinh viên truy cập khi giảng viên chưa upload tài liệu nào, hệ thống sẽ hiển thị thông báo rõ ràng thay vì lỗi.
- Ngân hàng câu hỏi được sinh theo 4 lô song song (mỗi lô ~25 câu, tập trung khía cạnh khác nhau của tài liệu) rồi lọc trùng — tổng số câu cuối cùng có thể dao động quanh mốc 100 tùy nội dung tài liệu.
