...
- Ngân hàng câu hỏi được sinh theo nhiều lô nhỏ (≤10 câu/lô) rồi lọc trùng — tổng số câu cuối cùng có thể thấp hơn một chút so với con số cấu hình tùy nội dung tài liệu.
